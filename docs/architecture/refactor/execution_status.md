...
| Item | Value |
| --- | --- |
| Active stage | 3 — Range Lifecycle |
| Last passed stage | 2 — Packet Flow / Backpressure |
| Stage 0 base | `622339136e563752885d8b5ee6a6a0157e28266c` |
| Stage 0 test rollback point | `98f891f` |
| Current branch | `codex/refactor-03-range-lifecycle` |
| Next slice | Read Phase 3 ticket and phase contract, then add its expected-red tests |
...
| 3 — Range Lifecycle | active | pending | pending |
