...
struct PerformanceSummary : performance::SummaryDirectPerformanceMetrics {
    ...
    double average_aligned_write_size_bytes = 0.0;
    double average_tail_write_size_bytes = 0.0;
    ...
    double queue_full_pause_start_queued_payload_bytes_avg = 0.0;
    double queue_full_pause_start_inflight_bytes_avg = 0.0;
    double queue_full_pause_start_memory_bytes_avg = 0.0;
    double memory_pause_start_queued_packets_avg = 0.0;
    double memory_pause_start_queued_bytes_avg = 0.0;
    double memory_pause_start_queued_payload_bytes_avg = 0.0;
    double memory_pause_start_inflight_bytes_avg = 0.0;
    double memory_pause_start_memory_bytes_avg = 0.0;
    double memory_pause_start_high_watermark_gap_bytes_avg = 0.0;
    double memory_pause_start_incoming_bytes_avg = 0.0;
    double memory_pause_start_delta_accounted_bytes_avg = 0.0;
    double memory_pause_start_current_handle_buffered_payload_bytes_avg = 0.0;
    double memory_pause_start_current_handle_buffered_accounted_bytes_avg = 0.0;
    double memory_pause_start_projected_handle_buffered_payload_bytes_avg = 0.0;
    double memory_pause_start_projected_handle_buffered_accounted_bytes_avg = 0.0;
    double memory_pause_start_active_buffered_accounted_bytes_avg = 0.0;
    double memory_high_watermark_start_active_requests_avg = 0.0;
    double memory_high_watermark_start_active_window_bytes_avg = 0.0;
    double memory_high_watermark_start_queued_payload_bytes_avg = 0.0;
    double memory_high_watermark_start_inflight_bytes_avg = 0.0;
    double memory_high_watermark_start_memory_bytes_avg = 0.0;
    double memory_low_watermark_resume_active_requests_avg = 0.0;
    double memory_low_watermark_resume_active_window_bytes_avg = 0.0;
    double memory_low_watermark_resume_queued_payload_bytes_avg = 0.0;
    double memory_low_watermark_resume_inflight_bytes_avg = 0.0;
    double memory_low_watermark_resume_memory_bytes_avg = 0.0;
    double memory_watermark_drain_queued_payload_bytes_avg = 0.0;
    double memory_watermark_drain_inflight_bytes_avg = 0.0;
    double memory_watermark_drain_memory_bytes_avg = 0.0;
